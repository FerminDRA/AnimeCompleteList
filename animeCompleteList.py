...
if agree:
    ...
    st.write("En este diagramase muestra la relacion entre la cantidad de animes que cuentan con distinta cantidad de episodios.")
    st.header("Grafica de barras")
    st.plotly_chart(fig_source)
    st.write("En este diagrama se muestra la cantidad de animes que fueron creados de las distintas fuentes.")
    st.header("Grafica de Scatter")
    st.plotly_chart(fig_scatter)
    st.write("En se muestra la relacion entre la cantidad de capitulos de los animes y su ranking a si como la categoria a la que pertenecen cada uno.")